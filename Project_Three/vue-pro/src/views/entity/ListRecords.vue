...
const loadRecords = async () => {
  ...
  try {
    ...
    if (data.length === 0) {
      ...
      showMessage(`Loaded ${data.length} records`, "success");
    }
  } catch (error) {
  ...
  <div class="list-records-container">
    <div class="list-card">
      <div class="list-header">
        <h1>List Records - Entity Management</h1>
      ...
      <div v-else-if="records.length === 0" class="empty-state">
        ...
        <p>There are no records in the database yet. Start by adding some records.</p>
        <button @click="$router.push('/entity/add')" class="btn">Add First Record</button>
      </div>

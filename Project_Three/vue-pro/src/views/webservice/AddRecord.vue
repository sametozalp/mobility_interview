...
const handleSubmit = async () => {
  ...
  try {
    await webService.addRecord(formData.value);
    showMessage("Record added successfully via Web Service!", "success");
    formData.value = {
      name: "",
      surname: "",
      age: 0,
    ...
    console.error("Error adding record via web service:", error);
    showMessage("Failed to add record via Web Service. Please try again.", "error");
  } finally {
...
<template>
  <div class="add-record-container">
    <div class="form-card">
      <h1>Add Record - Web Service Operations</h1>
      ...
      <form @submit.prevent="handleSubmit" class="record-form">
        ...
        <div class="form-actions">
          <button type="submit" class="btn" :disabled="isSubmitting">
            {{ isSubmitting ? "Adding via Web Service..." : "Add Record via Web Service" }}
          </button>

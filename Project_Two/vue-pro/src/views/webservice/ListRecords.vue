  ...
  <div class="list-records-container">
    <div class="list-card">
      ...
      <div v-else-if="records.length === 0" class="empty-state">
        ...
        <p>There are no records in the database yet. Start by adding some records via the Web Service.</p>
      ...
      <div v-else class="table-container">
        <table class="records-table">
          ...
          <tbody>
            <tr v-for="record in records" :key="record.id || `${record.name}-${record.PhoneNumber}`">
              <td>{{ record.name }}</td>
